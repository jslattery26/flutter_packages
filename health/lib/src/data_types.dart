...
const List<HealthDataType> _dataTypeKeysAndroid = [
  ...
  HealthDataType.ACTIVITY_SEGMENT,
];
...
const Map<HealthDataType, HealthDataUnit> _dataTypeToUnit = {
  ...
  HealthDataType.ACTIVITY_SUMMARY: HealthDataUnit.AGGREGATE_ACTIVITY_SUMMARY,
  HealthDataType.ACTIVITY_SEGMENT: HealthDataUnit.ACTIVITY,
};
...
const HealthDataUnitJsonValue = {
  ...
  HealthDataUnit.AGGREGATE_ACTIVITY_SUMMARY: 'aggregate_activity_summary',
  HealthDataUnit.ACTIVITY: 'activity',
};
